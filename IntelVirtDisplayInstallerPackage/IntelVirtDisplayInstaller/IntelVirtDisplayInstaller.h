...
#define INTELVIRTDISPLAYKMD_INF TEXT("IntelVirtDisplayKMD.inf")
#define INTELVIRTDISPLAYKMD_DESC L"IntelVirtDisplayKMD Device"
#define INTELVIRTDISPLAYUMD_DESC L"IntelVirtDisplay Device"
#define INTELVIRTDISPLAYINSTALLER_RUNDLL_EXE L"rundll32.exe"
#define INTELVIRTDISPLAYINSTALLER_RUNDLL_ARGUMENT L"IntelVirtDisplayEnabler.dll,intelvirtdisplay_init"
#define INTELVIRTDISPLAYINSTALLER_DLL_NAME L"IntelVirtDisplayEnabler.dll"
#define INTELVIRTDISPLAYINSTALLER_LEGACY_DLL_NAME L"DVEnabler.dll"
#define INTELVIRTDISPLAYINSTALLER_REG_RUN_PATH TEXT("Software\\Microsoft\\Windows\\CurrentVersion\\Run")
#define INTELVIRTDISPLAYINSTALLER_REG_DLL_KEYNAME TEXT("IntelVirtDisplayDll")
#define INTELVIRTDISPLAYINSTALLER_REG_EXE_KEYNAME TEXT("IntelVirtDisplayExe")
#define INTELVIRTDISPLAYINSTALLER_WIN_APP TEXT("DV")
#define INTELVIRTDISPLAYINSTALLER_INTELVIRTDISPLAYDLL_NAME "IntelVirtDisplay.dll"
#define INTELVIRTDISPLAYINSTALLER_DLL_FUNCTION L"intelvirtdisplay_init"
#define DVSERVER_KMD_DESC L"DVServerKMD Device"
#define DVSERVER_UMD_DESC L"DVServerUMD Device" // verify exact string in Device Manager on a ZC2400 system
...
BOOL dvUninstallLegacyKmdAndUmd(void);
