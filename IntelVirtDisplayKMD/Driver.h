...
EVT_WDF_DRIVER_DEVICE_ADD IntelVirtDisplayKMDEvtDeviceAdd;
EVT_WDF_OBJECT_CONTEXT_CLEANUP IntelVirtDisplayKMDEvtDriverContextCleanup;
EVT_WDF_DRIVER_UNLOAD IntelVirtDisplayKMDEvtDriverUnload;
...
#define INTELVIRTDISPLAYKMD_SUCCESS 1
#define INTELVIRTDISPLAYKMD_FAILURE 0
