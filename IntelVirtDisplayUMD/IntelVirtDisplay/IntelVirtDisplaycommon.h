...
;--------------------------------------------------------------------------*/
#ifndef __IntelVirtDisplay_COMMON_H__
#define __IntelVirtDisplay_COMMON_H__

#include "Driver.h"

/* IntelVirtDispUMD Error Codes */
#define INTELVIRTDISPLAYUMD_SUCCESS 0
#define INTELVIRTDISPLAYUMD_FAILURE -1
...
#endif /* __IntelVirtDisplay_COMMON_H__ */
