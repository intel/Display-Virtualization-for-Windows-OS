...
WDFDEVICE g_idd_device = NULL;
extern FILE* g_idd_fp;
...
NTSTATUS IddSampleDeviceAdd(WDFDRIVER Driver, PWDFDEVICE_INIT pDeviceInit)
{
	...
	if (idd_get_config_info() != IDD_SUCCESS) {
		WriteToLog("idd_get_config_info() failed. Fall back to IDD default.\n");
	}
	idd_get_monitor_modes();
